<?php
/* © 2022 Seolyzer.io */
require_once($_SERVER['DOCUMENT_ROOT'].'/seolyzer-bb4785028a27c12bbbdbc0886b3dc3ed.php');
?>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
       ...
       <meta property="twitter:title" content="Odacesoft • Agence d'ingénierie informatique à Parakou, Bénin">
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-5K9SZCXNCX"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
        
          gtag('config', 'G-5K9SZCXNCX');
        </script>
        @routes
