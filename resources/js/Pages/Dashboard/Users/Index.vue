  ...
  <div>
    ...
    <div class="main-content">
      ...
      <div class="col-md-8 max bg-white card ">
                ...
                <tbody v-if="datas">
                  ...
                  <td>{{ row.id }}</td>
                    <td data-label="Job Title">
                      ...
                      <button class="text-dark bg-white d-block" @click="ShowInfo(row)" >{{ row.name }}</button>
        ...
        <div class="card shadow-2 mt-2">

            <div v-if="sdata" class="card-body">
                <div class="row">

                    <h5 class="card-header text-center border-0 h3 mb-3 px-3 py-1">{{sdata.name}}</h5>
                    <div class="col-md-4 text-mute font-bold text-end">

                  </div>
                  <div class="col-md-8">
                    <img v-if="sdata.profile_photo_url" class="img-responsive rounded-circle border-1 shadow-sm w-24 mb-3" :src="sdata.profile_photo_url" :alt="sdata.profile_photo_url">

                  </div>
                    <div class="col-md-4 text-mute font-bold text-end">Nom :</div>
                    <div class="col-md-8">{{sdata.name}}</div>
                    <div class="col-md-4 text-mute font-bold text-end">Email :</div>
                    <div class="col-md-8">{{sdata.email}}</div>
                    <div class="col-md-4 text-mute font-bold text-end">Inscription :</div>
                    <div class="col-md-8"><i class="fas fa-calendar" aria-hidden="true"></i> {{sdata.h_created_at}}</div>

                    <div class="col-md-4 text-mute font-bold text-end" v-if='sdata.bio'>Biographie :</div>
                    <div class="col-md-8">
                        <div class="text-xs" v-html="sdata.bio"></div>
                    </div>
                </div>
            </div>
        </div>
...
export default {
  ...
  data() {
    return {
      titre: "Mots clés liés aux articles",
      nb: 0,
      sdata:null,
