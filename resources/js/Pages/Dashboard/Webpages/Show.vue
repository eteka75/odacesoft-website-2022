        ...
        <template #btn>
          <div>
            ...
            <inertia-link v-if="article"
              :href="route('page.edit', article.id)"
              class="
                btn
                d-inline-flex
          ...
          <div class="col-lg-8 p ">
            ...
            >
              ...
              <span>Retour</span>
                ...
                <li class="text-dark fw-bold font-bold">Slug :</li>
                    <li class="mx-1 text-primary" >{{article.slug}}</li>
                </ul>
                <div>
                    <img v-if="article.image"
                    :src="'/'+article.image.url"
                    class="img-responsive rounded-5 shadow-4_ mb-8"
