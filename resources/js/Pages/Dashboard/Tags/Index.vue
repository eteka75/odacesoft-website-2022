                ...
                <tbody v-if=' datas.data.length > 0'>
                  ...
                  <td>{{ row.id }}</td>
                    ...
                    <td  class="text-center">
                      <span class="badge bg-gray-700 text-white" v-if="row.articles"
                    ...
                    <td nowrap data-label="" class="text-center">

                         <button @click="ShowInfo(row)"   class="mx-1 text-muted bg-none">
                            <i class="fas fa-eye"></i>
                          </button>
                          <button
                            @click="edit(row)"
                          class="mx-1 text-muted bg-none"
                          >
                          <i class="fas fa-edit    "></i>
            ...
            <div  class="card-body">
                <div class="row text-xs">
                    ...
                    <div v-if="sdata.h_created_at!=sdata.h_updated_at"  class="col-md-8"> <i class="fas fa-calendar-check" aria-hidden="true"></i> {{sdata.h_updated_at}}</div>
                     ...
                     <div v-if="sdata.description" class="col-md-4 text-mute font-bold text-end">Description :</div>
                    <div  v-if="sdata.description"  class="col-md-8 text-xs">{{sdata.description}}</div>
                </div>
            </div>
        </div>
        </div>
