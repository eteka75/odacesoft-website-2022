                ...
                <div class="modal-body">
                  <div class="form-group d-flex gx-2 mb-4">
                    <div class="col ">
                      <div class="form-floating">
                        ...
                        <label for="real">Le nom du dossier image</label>
                      </div>
                      <div
                  ...
                  <div class="form-group mb-3">
                      <div class="form-floating">
                        ...
                        <label for="part">Résume du dossier en 250 caractères maximum (*)</label>
                      </div>
                      <div
                  ...
                  <tbody v-if="datas.data.length > 0">
                    <tr  @click="ShowInfo(row)"    :class="(sdata && row && row.id==sdata.id)?'bg-primary text-white':''"  v-for="row in datas.data" v-bind:key="row">
                      ...
                      <td data-label="" class="text-center">
                              ...
                              <inertia-link
                                :href="route('galerie-image.show',row.id)"
            ...
            <div v-if="sdata" class="card shadow-1 mt-3">
              <div class="card-body">
                <div class="row text-xs">
                  ...
                  <h5 class="card-header border-0 h4 mb-3 px-3 py-1 text-uppercase txt-center">{{ sdata.titre }}</h5>
  ...
  methods: {
    ...
    AddPlugin() {
      ...
      $("#summernote").summernote({
        placeholder: "Rédiger votre contenu ici ...",
        tabsize: 2,
        height: 300,
    ...
    save: function (data) {
      ...
      //this.$inertia.post(route('tags.store'), data);
       if (this.ClickEditor() ) {
        this.$inertia.post(route("galerie-image.store"), data, {
    ...
    update: function (data) {
      data._method = "PUT";
      var url = route("galerie-image.update", data.id);
      if (this.ClickEditor() ) {
    ...
    deleteRow: function (data) {
      ...
      data._method = "DELETE";
      this.$inertia.post(route("galerie-image.destroy", data.id), data);
      this.reset();
      this.closeModal();
    },
    selectImage() {
