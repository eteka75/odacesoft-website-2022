        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-xl-3">
              ...
              <div class="card-body p-4">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <input id="vtags" class="d-none hidden form-control" />
                  </div>
                   <div
            ...
            <div class="card rounded-2 mb-4 shadow-1">
              ...
              <div class="floats-end">
                    <div class="form-check form-switch">
                        <input
                                value="1"
                                class="form-check-input"
                                v-model="form.supimg"
                                :error="form.errors.supimg"
                                name="supimg"
                                type="checkbox"
                                id="supimg"
                            />
                            <label class="form-check-label" for="supimg"
...
export default {
  ...
  methods: {
    ...
    initData() {
        ...
        this.form.contenu = this.article.content;
        this.form.categorie_id = (this.article.categories)? this.article.categories.id:null;
        this.form.publie = (this.article.actif>=1)?true:false;
        this.previewImage = (this.article.image)? '/'+this.article.image.url:null;
        if(this.article && this.article.tags){
            for(var i=0; i<this.article.tags.length; i++) {
                if(this.form.tags!==null ){
                    this.form.tags = this.form.tags+','+this.article.tags[i].nom;
                }else{
                    this.form.tags = this.article.tags[i].nom+',';
                }
            }
        }
    ...
    update() {
      ...
      if (this.ClickEditor() && this.setTag()) {
        this.$inertia.post(this.route("article.update",this.form.id), this.form, {
          forceFormData: true,
        });
      }
    },
