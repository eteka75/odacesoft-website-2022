      ...
      <div class="col-md-8 max bg-white card ">
        ...
        <div class="card shadow-2 mt-2">
            ...
            <div v-if="sdata" class="card-body">
                <div class="row">
                    <h5 class="card-header h3 mb-3 px-3 py-1">{{sdata.name}}</h5>

                    <div class="col-md-4 text-mute font-bold text-end">Cétgorie :</div>
                    ...
                    <div class="col-md-4 text-mute font-bold text-end">Biographie :</div>
                    <div class="col-md-8">
