                ...
                <div class="modal-body">
                  <div class="form-group d-flex gx-2 mb-4">
                    <div class="col ">
                      <div class="form-floating">
                        ...
                        <label for="categ">Le nom de la ressource (*)</label>
                      </div>
                      <div
                  ...
                  <div class="form-group mb-3">
                      <div class="form-floating">
                        ...
                        <label for="categ">Description de la ressource (*)</label>
                      </div>
                      <div
            ...
            <div class="card rounded-2 mb-4 shadow-1">
              <div class="card-body p-4">
                <div class="mb-3">
                  ...
                  >
                  <div class="mb-2 text-xs text-muted"><b>Format autorisés:</b> jpeg,png,jpg,zip,pdf,ppt, pptx, xlx, xlsx,docx,doc,gif,webm,mp4,mpeg</div>
              ...
              <div class="table-responsive py-3 rounded-sm min-h">
                ...
                >
                  ...
                  <tbody v-if="datas.data.length > 0">
                    <tr v-for="row in datas.data" @click="ShowInfo(row)"  :class="(sdata && row && row.id==sdata.id)?'bg-primary text-white':''"  v-bind:key="row">
                      <td>{{ row.id }}</td>
                      <td data-label="Job Title">
                        ...
                        <p>{{liveSubstr(row.resume,0,66)}}</p>
                      </td>
                      <td >
                         {{ row.type }}
                      </td>
                      <td >
                        ...
                        <span v-if="!row.actif" class="badge  rounded-5  "  :class="(sdata && row && row.id==sdata.id)?'bg-white text-dark':''" >Désactivé</span>
                      </td>
                      <td data-label="Lead Score">
                        {{ row.h_created_at }}
                      </td>
                      <td data-label="" class="text-center">
                              <button @click="edit(row)" :class="(sdata && row && row.id==sdata.id)?'text-white':'text-gray'" class="d-inline mx-1 bg-none">
                                <i class="fas fa-edit"></i>
                                 </button>
            ...
            <div v-if="sdata" class="card shadow-1 mt-3">
              <div class="card-body">
                <div class="row text-xs">
                  ...
                  <h5 class="card-header h4 mb-3 px-3 py-1 text-uppercase">{{ sdata.title }}</h5>
  ...
  methods: {
    ...
    save: function (data) {
      ...
      //this.$inertia.post(route('tags.store'), data);
       if (this.ClickEditor() ) {
        this.$inertia.post(route("ressource.store"), data, {
    ...
    update: function (data) {
      data._method = "PUT";
      var url = route("ressource.update", data.id);
      if (this.ClickEditor() ) {
    ...
    deleteRow: function (data) {
      ...
      data._method = "DELETE";
      this.$inertia.post(route("ressource.destroy", data.id), data);
      this.reset();
      this.closeModal();
    },
    selectImage() {
