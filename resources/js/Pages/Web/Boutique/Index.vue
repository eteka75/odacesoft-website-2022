      ...
      <div class="row">
        <div class="col-md-12  text-md-center">
          <div class="py-6 py-md-12 py-xl-10">
            ...
            <p class="lead">Découvrez nos produits et services ici</p>
          ...
          <div class="row">
              <div class="col-md-12">
                <div class="px-3 px-lg-8 mb-8 text-center rounded-sm shadow-hover py-5 py-lg-10 bg-gray-100">
                  <h1 class="display-3"> <i class="fa fa-shopping-basket" aria-hidden="true"></i></h1>
                  <h3>Aucun produit n'est disponible pour ne moment</h3>
