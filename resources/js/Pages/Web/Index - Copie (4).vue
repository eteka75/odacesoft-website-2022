    ...
    <div class="r">
            <div class="bd-example">
                ...
                <div class="carousel-inner">
                    <div v-for='(row,i) in slides' :key="i"  class="carousel-item" :class="i==0?'active':''">
    ...
    <div class="d-flex flex-grow-1">
      <div class="w-full">
        ...
        <div class="container-lg py-4 py-md-5">
						...
						<div class="overlap-grid overlap-grid-2">
							<div class="item">
								<figure class="roundedshadow-lg">
                                    <iframe height="420" width="100%" src="https://www.youtube.com/embed/7MtG83wB1-k" title="YouTube video player" class="p-3 bg-white embed-responsiveimg-responsive shadow-4 w-full rounded-5" frameborder="0" controls=0 rel=0 autoplay=1 loop=1 allow=" autoplay; clipboard-write; encrypted-media;  picture-in-picture" allowfullscreen></iframe>
                                    <!--iframe height="420" width="100%" src="https://www.youtube.com/embed/YXuU3YpdUtA" title="YouTube video player" class="embed-responsiveimg-responsive shadow-4 w-full rounded-5" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-pictures" allowfullscreen></iframe-->
                                </figure>
							</div>
						</div>
					</div>
                ...
                <div class="mt-6">
                  <inertia-link class="btn btn-primary rounded-3xl" :href='route("contact")'> Contactez-nous -> </inertia-link>
        ...
        <section>
            <div class="bg-light-boxed-right bg-checkered  py-10 py-xl-20 text-">
				...
				<div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
					...
					<!--/column -->
					<!--div class="col-lg-6 order-1 text-dark">
						<h2 class="display-6 mb-3">Comment ça marche ?</h2>
						<p class="lead fs-lg pe-lg-5 text-dark">Nous avons pour ambitions de créer un écosystème autours des technologies qui permettent à vos affaires de croitre beaucoup plus rapidement.
                         </p>
						<p class="text-dark">Nous travaillons à identifier avec vous les meilleures idées adaptées à vos objectifs de vente, de carrière dans le numérique ou pour la résolution d'un problème pertinent de notre environnement.
						...
						<p class="mb-6 text-dark">Nous vous accompagnos enfin à mettre en oeuvre la solution choisie et à vous suivre sur le chemin de la réussite. Enfin de compte, vous êtes gagnant et nous le sommes également.</p>
                        <p class="font-bold h2 text-dark font-light">Avez vous besoins d'un coup de pouce sur un projet dans le numérique ?</p>
                        <inertia-link class="btn btn-primary btn-sm mt-4  rounded-pill shadow-hover mb-0" :href="route('contact')" >Ecrivez-nous</inertia-link>
					</div-->
					<!--/column -->
				</div>
				<!--/.row -->
                            ...
                            <div  v-for="article in activites" id="article-top"
                                :key="article" class="card h-100 item shadow-1 shadow-hover-4 rounded-3 ">
                                    ...
                                    <div class="clearfix mb-3">
                                        <span  v-if="article.categories && article.categories.length > 0"  class="float-start badge rounded-pill bg-gray-300 text-muted " :class="article.categories.couleur"
                                        ><inertia-link  v-if="article.categories && article.categories.length > 0" class="text-white" :href='route("blog.cat.show",article.categories.id)'>{{ article.categories.nom }}</inertia-link></span
                                        >
                                    </div>
...
props: {
  ...
  methods:{
   ...
   initCarroussel:function(){
    ...
    props:['title','cat_services','top_services','partenaires','pageMVV','realisations','activites','services','pays','articles','slides']
  ,
    metaInfo: {
