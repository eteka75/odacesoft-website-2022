<template>
  ...
  <cover-layout>
    <div
      id="services-partenaires"
      class="
        transition transition-all
        duration-700
        ease-linear
        delay-200
        shadow-lg p-10 border-1 border-primary
      "
    >
                  ...
                  <table class="table-fixed w-full">
                    ...
                    <tbody>
                      <tr v-for="row in data" v-bind:key="row">
                        ...
                        <td class="border px-4 py-2">{{ row.titre }}</td>

                        <td class="border px-4 py-2">{{ row.contenu }}</td>
